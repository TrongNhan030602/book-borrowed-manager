    ...
    <Form @submit="submitBorrow" :validation-schema="borrowFormSchema" class="my-form">
      ...
      <div class="form-group">
        ...
        <Field
          ...
          type="text"
          class="form-control"
          :value="formatDate(borrowLocal.borrowDate)"
          readonly
        />
      ...
      <div class="form-group">
        ...
        <Field name="status" type="text" class="form-control" v-model="borrowLocal.status" readonly />
    ...
    data() {
      ...
      const borrowFormSchema = yup.object().shape({
        ...
        bookName: yup
          ...
          .required("Name is required.")
          .min(2, "Name must be at least 2 characters.")
          .max(66, "Name must be at most 66 characters."),
